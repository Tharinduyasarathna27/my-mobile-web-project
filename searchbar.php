	...
	<body>
		...
		<div class="header">
			<div class="search-bar">
				<form  method="POST">
					<input type="text" name="search"><button id="searchbtn">Search</button> <!-- type="submit"   -->value="Search" />
				</form>
			</div>
			<div class="clear"> </div>
							...
							<div id="id01" class="modal">
							  ...
							  <div class="imgcontainer">
							    ...
							    <div class="container">
							      ...
							      <button class="buttonlog" id="logbtn" onclick="validateForm()">Login</button>
